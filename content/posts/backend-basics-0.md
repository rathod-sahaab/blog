...
![Abhay Raj Singh's github profile screenshot to show profile visits couter](/media/rs-gh-profile.png)
...
<figure>
  <blockquote>
    <p>A picture something-something a thousand words...</p>
    <footer>
    <cite>
    &ndash; Not me
    </cite>
...
Screenshot
![Visit counter demo screenshot](/media/visits-counter-demo.png)
...
2. You can use somebody else's counter on your profile. Below I use [ryanlanciaux](https://github.com/ryanlanciaux)'s counter, the author of the counter in start of this blog.
   <p><img src="https://profile-counter.glitch.me/ryanlanciaux/count.svg" alt="" /></p>
